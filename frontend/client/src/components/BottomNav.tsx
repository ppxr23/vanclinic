...
import { Home, Calendar, FileText, ShoppingBag, User, LayoutGrid } from 'lucide-react';
    ...
    <nav style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: 'white', borderTop: '1px solid #d0e8e6', zIndex: 100 }}>
      {isStaff && (
        <button
          ...
          style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '8px 16px', background: NAVY, border: 'none', cursor: 'pointer', fontFamily: 'inherit', fontSize: 12, fontWeight: 700, color: 'white', letterSpacing: '0.3px' }}
        >
          <LayoutGrid size={14} />
